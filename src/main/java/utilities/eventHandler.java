...
public class eventHandler  implements WebDriverListener {
    ...
    public void beforeGet(WebDriver driver, String url) {
        extentReportUtility.loger.log(Status.INFO,"Navigating to Url : "+url);

    }

    @Override
    public void afterGet(WebDriver driver, String url) {
        extentReportUtility.loger.log(Status.PASS,"Navigated to Url : "+url);
    ...
    public void beforeFindElement(WebDriver driver, By locator) {
        extentReportUtility.loger.log(Status.INFO,"Searching the Web Element.... : "+locator);
    }

    @Override
    public void afterFindElement(WebDriver driver, By locator, WebElement result) {
        extentReportUtility.loger.log(Status.PASS,"Successfully found the  Web Element.... : "+locator);
    }

    @Override
    public void beforeFindElements(WebDriver driver, By locator) {
        extentReportUtility.loger.log(Status.INFO,"Searching the Web Elements List.... : "+locator);
    }

    @Override
    public void afterFindElements(WebDriver driver, By locator, List<WebElement> result) {
        extentReportUtility.loger.log(Status.PASS,"Successfully found the  Web Element List.... : "+locator);
    }
